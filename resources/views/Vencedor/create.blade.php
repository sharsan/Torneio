      ...
      <div class="form-group col-md-8">   
           ...
           <div class="col-md-8">
                <label for="nome"> Nome do campeonato :</label>
                   <input type="text" class="form-control" name="nome"placeholder="Ex: Campeonato - Lurdes Mutola 2018 "></input> 
      ...
      <div class="form-group col-md-8"> 
            <div class="col-md-6">     
                <label for="juri">Júri : </label> 
                  <input type="text" class="form-control" name="juri"placeholder="Ex: Marcos"></input>
